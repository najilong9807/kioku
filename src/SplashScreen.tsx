      ...
      <div className="splash-book-wrap">
        ...
        >
          ...
          <ellipse
            ...
            opacity="0.12"
          />
          {/* 메인(세이지 그린) 노트의 정적인 부분이에요. 표지가 다 닫혔을 때의 책
              폭으로 그려져 있고, 중앙(x=130)에 오도록 배치했어요. 회색 배경과 톤이
              가까워서 테두리 선을 둘러 윤곽을 또렷하게 했어요. 오른쪽 안쪽 페이지와
              그 위를 덮는 표지는 아래 HTML 레이어로 겹쳐서 표현해요. */}
          <rect
            x="70"
            y="14"
            width="120"
